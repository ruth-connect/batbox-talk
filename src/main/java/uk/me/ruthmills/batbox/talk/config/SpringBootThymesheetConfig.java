package uk.me.ruthmills.batbox.talk.config;
...
import uk.me.ruthmills.batbox.talk.thymeleaf.TalkDialect;
import uk.me.ruthmills.batbox.talk.thymesheet.SpringBootThymesheetTemplateModeHandler;
...
public class SpringBootThymesheetConfig {
	...
	public SpringThymesheetTemplateEngine templateEngine() {
		...
		additionalDialects.add(new TalkDialect());
